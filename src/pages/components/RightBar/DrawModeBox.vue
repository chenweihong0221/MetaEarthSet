...
import { mapKey, stateKey } from "@mars/pages/module/store/store"
import * as mars3d from "mars3d"
import { Building, Floor, setHeight } from "@mars/pages/module/model/Building"
import { Cesium } from "mars3d"
import MarsButton from "@mars/components/mars-ui/mars-button/index.vue"
import { CesiumRoleController } from "@mars/pages/module/store/CesiumRoleController"
...
import { updateCamera } from "@mars/pages/api/api"
...
const handleAddCamera = () => {
  ...
  store.state.map.once("click", event => {
    ...
    const camera = window.polygonToParent.get(deviceId.value.toString())
